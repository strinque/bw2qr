...
namespace details
{
  ...
  const std::map<option_id, std::string> option_name = 
  {
    ...
    {option_id::frame_border_size,        "frame-border-size"},
    {option_id::frame_logo_status,        "frame-logo-status"},
...
namespace option
{
  ...
  using frame_border_size       = details::option_data<details::option_id::frame_border_size,       uint8_t>;
  using frame_logo_status       = details::option_data<details::option_id::frame_logo_status,       bool>;
...
namespace details
{
  ...
  using OptionsVal = 
    std::variant<
      ...
      option::frame_border_size,
      option::frame_logo_status,
  ...
  public:
      ...
      m_opts()
    {
      for (const auto& o : opts)
      {
        ...
        else if (std::holds_alternative<option::frame_border_size>(o))        setArg(option_id::frame_border_size,        std::get<option::frame_border_size>(o).arg);
        else if (std::holds_alternative<option::frame_logo_status>(o))        setArg(option_id::frame_logo_status,        std::get<option::frame_logo_status>(o).arg);
